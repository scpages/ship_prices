...
<div class="container">
  <div class="stats">
    ...
    <div class="stat"><div class="stat-val">${Object.keys(rentMap).length}</div><div class="stat-lbl">Rentable</div></div>
  </div>
...
console.log(`index.html generated (${vehicles.length} ships)`);
